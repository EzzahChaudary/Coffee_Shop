...
.btn.add-to-cart:hover {
    background-color: #6F3C12; /* Darker Brown */
    border-color: #6F3C12;
...
<body>
                ...
                <div class="product-grid">
                    <% 
                        String[][] products = {
                            ...
                            {"Mocha", "$4.00", "images/m3.jpg", "A chocolate-flavored variant of a latte."},
                            {"Flat White", "$4.25", "images/m4.png", "Smooth and velvety coffee."},
                            {"Black Coffee", "$5.00", "images/m8.png", "Pure coffee goodness, no frills."},
    ...
    <form action="CartController" method="GET">
        ...
        <input type="hidden" name="imageUrl" value="<%= product[2] %>">
